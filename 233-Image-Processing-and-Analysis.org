...
- Analyze image enhancement and segmentation algorithms for image processing application. (K4)
...
- Apply the techniques for image analysis using various features. (K3)
- Make use of the multi resolution techniques and methods used for color images. (K3)
- Infer a positive professional contribution in the field of Digital Image Processing. (K4)
